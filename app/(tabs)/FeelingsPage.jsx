    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('CalendarPage')} // Navigate to CalendarPage
        >
      ...
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('Entry')} // Navigate to NewEntryPage
      >
      ...
      <ScrollView>
        <View style={styles.entry}>
          ...
          <View style={styles.entryContent}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('EntryDetailsPage')}> 
